...
<div class="container">
    ...
    <form  onclick="return false;" id="pagination-form">
        ...
        <input type="hidden" name="restart" value="GetProductCategoryList">
...
<script>
    ...
    function EditProductCategory(c_id=0)
    {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: '<?php echo apath; ?>' +'panel/important/ajax.php',
            data: $("#product_category_edit_form").serialize(),
            success: function(data) {
                var resMessageData = jQuery.parseJSON(data['responseMessage']);
                autoSystemMessage(resMessageData);
                GetProductCategoryList();
    ...
    function GetProductCategoryList()
    {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: '<?php echo apath; ?>' +'panel/important/ajax.php',
            data: 'ajax=true&build=GetAllProductCategory&page='+pageValue+'&count_data='+countDataValue+'&size='+size+'&search_key='+search_key+'&sort_by_name='+sort_by_name + '&sort_by_table_count=' + sort_by_table_count,
            success: function(data) {
                var resMessageData = jQuery.parseJSON(data['responseMessage']);
