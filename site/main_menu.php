<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-list"></i><span class="menu-title" data-i18n="Data List">Masa İşlemleri</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
                    <ul class="menu-content">
                        <li><a href="index.php?state=list&page=table_category"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List View">Masa Kategorileri</span></a>
                        </li>
                        <li><a href="index.php?state=add&page=table_category"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Thumb View">Masa Kategorisi  Ekle</span></a>
                        </li>
                        <li><a href="index.php?state=list&page=table"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Thumb View">Masalar</span></a>
                        </li>
                        <li><a href="index.php?state=add&page=table"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Thumb View">Masa Ekle</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="feather icon-menu"></i><span class="menu-title" data-i18n="Menu Levels">Ürün İşlemleri</span></a>
                    <ul class="menu-content">
                        <li><a href="#"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Second Level">Ürün</span></a>
                            <ul class="menu-content">
                                <li><a href="index.php?state=list&page=product"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Third Level">Ürünler</span></a>
                                </li>
                                <li><a href="index.php?state=add&page=product"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Third Level">Ürün Ekle</span></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    <ul class="menu-content">
                        <li><a href="#"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Second Level">Kategori</span></a>
                            <ul class="menu-content">
                                <li><a href="index.php?state=list&page=product_category"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Third Level">Ürün Kategorileri</span></a>
                                </li>
                                <li><a href="index.php?state=add&page=product_category"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Third Level">Ürün Kategori Ekle</span></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
